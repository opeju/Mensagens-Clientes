...
const FormularioServicoComAutocomplete = ({ servico, onUpdate, onRemove, index, dataServicos }) => {
  ...
  useEffect(() => {
    if (servico.horarioEmbarque && dataServicos) {
      const info = ContatoEmergenciaService.determinarContato(
  ...
  }, [servico.horarioEmbarque, dataServicos, servico.tipo]);
  ...
  return (
    <div className="border border-gray-200 rounded-lg p-4 bg-gray-50 space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        {/* Local Embarque com Autocomplete */}
        <AutocompleteField
          label="Local Embarque"
          value={servico.localEmbarque}
          onChange={(valor) => handleChange('localEmbarque', valor)}
          placeholder="Ex: Hotel, Aeroporto, Endereço"
          tipo="LOCAIS_EMBARQUE"
          required
        />

        {/* Local Desembarque com Autocomplete */}
        <AutocompleteField
          label="Local Desembarque"
          value={servico.localDesembarque}
          onChange={(valor) => handleChange('localDesembarque', valor)}
          placeholder="Ex: Hotel, Aeroporto, Endereço"
          tipo="LOCAIS_DESEMBARQUE"
          required
        />
...
export default FormularioServicoComAutocomplete;
